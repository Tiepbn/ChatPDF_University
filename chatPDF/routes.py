...
def baseuser():
    ...
    # today = any(int(datetime.today().strftime('%d')) - int(topic.date.day.strftime('%d')) == 0 for topic in user.topics)
...
def add_topic():
    ...
    # return redirect(url_for('baseuser', topic=new_topic.id))
